...
<div class="col-6">
    ...
    <div class="form-grup">
            ...
            <input name="golongan" class="form-control @error('golongan') is-invalid @enderror" value="{{ old('golongan') }}">
        <div class="text-denger">
            @error('golongan')
            {{ $message }}
            @enderror
    ...
    <div class="form-grup">
            ...
            <input name="tgl_lahir" class="form-control @error('tgl_lahir') is-invalid @enderror" value="{{ old('tgl_lahir') }}">
        <div class="text-denger">
            @error('tgl_lahir')
            {{ $message }}
            @enderror
    ...
    <div class="form-grup">
            ...
            <input name="tgl_pensiun" class="form-control @error('tgl_pensiun') is-invalid @enderror" value="{{ old('tgl_pensiun') }}">
        <div class="text-denger">
            @error('tgl_pensiun')
            {{ $message }}
            @enderror
    ...
    <div class="form-grup">
            <label>DIVISI</label>
            <input name="divisi" class="form-control @error('divisi') is-invalid @enderror" value="{{ old('divisi') }}">
        <div class="text-denger">
            @error('divisi')
            {{ $message }}
            @enderror
    ...
    <div class="form-grup">
            <label>AREA</label>
            <input name="area" class="form-control @error('area') is-invalid @enderror"value="{{ old('area') }}">
        <div class="text-denger">
            @error('area')
            {{ $message }}
            @enderror
